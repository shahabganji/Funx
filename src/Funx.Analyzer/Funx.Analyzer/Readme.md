...
### Funx.Analyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Funx.Analyzer.Sample.csproj](../Funx.Analyzer.Sample/Funx.Analyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

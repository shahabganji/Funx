...
namespace Nyx
{
    public class Option<T>
    {
        ...
        public static implicit operator Option<T>(T value) => value == null ? (Option<T>) None : Some(value);

        public TR Match<TR>(Func<TR> none, Func<T, TR> some) => _isSome ? some(this._value) : none();
